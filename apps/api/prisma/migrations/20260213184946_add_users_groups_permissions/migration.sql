...
-- AlterTable
ALTER TABLE "Template" ADD COLUMN     "groupId" TEXT,
ADD COLUMN     "ownerId" TEXT;
...
-- AddForeignKey
ALTER TABLE "Template" ADD CONSTRAINT "Template_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "Group"("id") ON DELETE SET NULL ON UPDATE CASCADE;
