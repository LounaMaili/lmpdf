...
export const SunIcon = ({ size = 18, ...p }: IconProps) => (
  <svg {...iconBase} width={size} height={size} {...p} aria-label={p.title ?? 'Light mode'}>
    {iconTitleBase(p.title ?? 'Light mode')}
...
export const MoonIcon = ({ size = 18, ...p }: IconProps) => (
  <svg {...iconBase} width={size} height={size} {...p} aria-label={p.title ?? 'Dark mode'}>
    {iconTitleBase(p.title ?? 'Dark mode')}
